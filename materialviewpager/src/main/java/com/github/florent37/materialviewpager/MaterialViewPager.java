...
public class MaterialViewPager extends FrameLayout implements ViewPager.OnPageChangeListener {
     ...
     */
    public MaterialViewPagerAnimator animator;
    public MaterialAppCombatActivity activity;
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        animator = MaterialViewPagerHelper.getAnimator(this.getContext());
    ...
    public void setMaterialViewPagerListener(Listener listener) {
        ...
        //this.getHeaderBackgroundContainer().invalidate();
