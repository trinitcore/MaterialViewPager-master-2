...
public class MaterialViewPagerAnimator {
    ...
    public boolean onMaterialScrolled(Object source, float yOffset) {
        ...
        if (ENABLE_LOG) {
            ...
            if (yOffset > 44){
                materialViewPager.activity.ToolbarWillAppear();
            }else if(yOffset < 44){
                materialViewPager.activity.ToolbarDidDissappear();
            }



            if (yOffset > 211){
                materialViewPager.activity.ToolbarDidAppear();
            }else if (yOffset < 211){
                materialViewPager.activity.ToolbarWillDissapear();
            }
